...
export default function Wireframes() {
  return (
    <section className="h-fit bg-black flex flex-col text-white items-center text-center py-[10vh]">
      ...
      <ol className="list-disc text-[30px] text-left w-[80%] space-y-10 my-[10vh]">
        <li>
          ✅ Enable users to
        ...
        <li>
          ✅ <span className="font-bold">Develop an onboarding</span> script for
          engineers to give users a quick tutorial on how to use the software
          effectively.
        </li>
        <li>
          ✅ Enable users to
